...
public class MapPanel extends JPanel {
  ...
  private List<List<Integer>> clusterTours = List.of();
  ...
  public void setClusterTours(List<List<Integer>> clusterTours) {
    this.clusterTours = (clusterTours == null) ? List.of() : clusterTours;
    repaint();
  }
